...
最终推理权重从 [checkpoints-v1](https://github.com/ucaspzl/PhaseMatcher/releases/tag/checkpoints-v1) 下载。
下载与放置方法：[中文](../docs/resources.zh-CN.md) · [English](../docs/resources.md)。
